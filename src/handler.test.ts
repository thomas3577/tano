...
Deno.test(`handler > Should have one task.`, () => {
...
Deno.test(`handler > Should have two task.`, () => {
...
Deno.test(`handler > Should throws an error if no default-task and no task set.`, async () => {
  task('myTask', `deno eval 1`);
...
Deno.test(`handler > Should run one task.`, async () => {
  task('myTask', `deno eval 1`);
...
Deno.test(`handler > Should throws an error if trying to runs two times.`, async () => {
  task('default', needs('pre-task'), `deno eval 1`);
  task('pre-task', `deno eval 1`);
...
Deno.test(`handler > Should runs two times.`, async () => {
  task('default', needs('pre-task'), `deno eval 1`);
  task('pre-task', `deno eval 1`);
...
Deno.test(`handler > Should abort at first error`, async () => {
  try {
    task('pre-task-one', () => {
...
Deno.test(`handler > Should NOT abort at first error`, async () => {
  task('pre-task-one', () => {
    throw new Error('ERROR! ERROR! ERROR!');
  });
  task('pre-task-two', `deno eval 1`);
...
Deno.test(`handler > Should deduplicate shared dependencies in execution plan`, async () => {
  task('shared', () => {});
...
Deno.test(`handler > Should group independent tasks into levels`, () => {
  task('shared', () => {});
  task('task-a', needs('shared'), () => {});
  task('task-b', needs('shared'), () => {});
  task('default', needs('task-a', 'task-b'), () => {});
...
Deno.test(`handler > Should put a task after the deepest of its needs`, () => {
  task('a', () => {});
  task('b', needs('a'), () => {});
...
Deno.test(`handler > Should return a single level for a task without needs`, () => {
  task('lonely', () => {});

  assertEquals(handler.getLevels('lonely'), [['lonely']]);
});

Deno.test(`handler > Should fail on circular dependencies`, async () => {
