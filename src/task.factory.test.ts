...
Deno.test(`${task.name} > create tasks > Task Var 01`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 02`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 03`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 04`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 05`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 06`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 07`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 08`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 09`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 10`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 11`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 12`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 13`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 14`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 15`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 16`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 17`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 18`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 19`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 20`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 21`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 22`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 23`, () => {
...
Deno.test(`${task.name} > create tasks > Task Var 24`, () => {
...
Deno.test(`${task.name} > run tasks > run one task with a command`, async () => {
  const actual: Task = task('my-task-100', `deno eval 1`);
...
Deno.test(`${task.name} > run tasks > run one task with a function`, async () => {
...
Deno.test(`${task.name} > run tasks > run two task with a command and a function`, async () => {
  task('my-pretask-102-01', `deno eval 1`);
...
Deno.test(`${task.name} > run tasks > Should gets an output`, async () => {
  await task('my-task-103', `deno eval 'console.log("First Task")'`, {
...
Deno.test(`${task.name} > run tasks > Should gets an error output`, async () => {
