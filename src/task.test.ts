...
Deno.test(`${Task.name} > Should create a instance of Task`, () => {
...
Deno.test(`${Task.name} > Should run the command line.`, async () => {
  const needs: string[] = [];

  const actual: Task = new Task('task-test-02', needs, `deno eval 1`);
...
Deno.test(`${Task.name} > Should run the function. (1)`, async () => {
...
Deno.test(`${Task.name} > Should run the function. (2)`, async () => {
...
Deno.test(`${Task.name} > Should not run if conditions false. (1)`, async () => {
  const func = () => {/* do nothing */};
  const needs: string[] = [];
  const options: TOptions = {
    condition: 1 + 2 === 4,
...
Deno.test(`${Task.name} > Should not run if conditions false. (2)`, async () => {
  const func = () => {/* do nothing */};
  const needs: string[] = [];
  const options: TOptions = {
    condition: () => false,
...
Deno.test(`${Task.name} > Should not run if conditions false. (3)`, async () => {
  const func = () => {/* do nothing */};
  const needs: string[] = [];
  const options: TOptions = {
...
Deno.test(`${Task.name} > Should not run if conditions false. (4)`, async () => {
  const func = () => {/* do nothing */};
  const needs: string[] = [];
  const options: TOptions = {
    condition: async () => {
...
Deno.test(`${Task.name} > Should not run if conditions false. (5)`, async () => {
  const func = () => {/* do nothing */};
  const needs: string[] = [];
  const options: TOptions = {
    condition: () => {
